...
public class ApiUtils {
    ...
    public static String CODEFORCES_BASE_URL = "https://codeforces.com";
    ...
    public static String GET_CODEFORCES_SUBMISSIONS_PATH = CODEFORCES_BASE_URL + "/submissions";
    public static String GET_CODEFORCES_SUBMISSION_SOURCE_CODE_PATH = CODEFORCES_BASE_URL + "/data/submitSource";
}
